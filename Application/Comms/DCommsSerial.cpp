...
*
* @file     DCommsSerial.cpp
* @version  1.00.00
* @author   Harvinder Bhuhi
* @date     25 March 2020
*
* @brief    The serial (RS485) communications class source file
*/
//*********************************************************************************************************************
...
/* User code --------------------------------------------------------------------------------------------------------*/
/**
 * @brief   DCommsSerial class constructor
 * @param   void
 * @retval  void
 */
...
/**
 * @brief   DCommsSerial initialisation function (overrides the base class)
 * @param   void
 * @retval  void
 */
void DCommsSerial::initialise(void)
{
    ...
    commsMedium = new DDeviceSerialRS485();
