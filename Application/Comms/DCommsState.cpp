...
/* Error handler instance parameter starts from 1101 to 1200 */
/* Typedefs ---------------------------------------------------------------------------------------------------------*/

/* Defines ----------------------------------------------------------------------------------------------------------*/
#define SHUTDOWN_TIME_60_MIN    (60u * 60u * 1000u)      // in miliseconds - 60 mins * 60s/mins * 1000ms/s
#define SHUTDOWN_TIME_5_MIN     (5u * 60u * 1000u)      // in miliseconds - 5 mins * 60s/mins * 1000ms/s
/* Macros -----------------------------------------------------------------------------------------------------------*/
