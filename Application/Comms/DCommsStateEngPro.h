...
private:
    ...
    static sEngProError_t fnConfigValve(void *instance, sEngProtocolParameter_t *parameterArray);
    static sEngProError_t fnGetRate(void *instance, sEngProtocolParameter_t *parameterArray);
...
public:
    ...
    sEngProError_t fnConfigValve(sEngProtocolParameter_t *parameterArray);
    sEngProError_t fnGetRate(sEngProtocolParameter_t *parameterArray);
};
