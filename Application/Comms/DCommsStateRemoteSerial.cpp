...
*
* @file     DCommsStateRemoteSerial.cpp
* @version  1.00.00
* @author   Harvinder Bhuhi
* @date     04 June 2020
*
* @brief    The serial communications remote state class source file
*/
//*********************************************************************************************************************
...
/* User code --------------------------------------------------------------------------------------------------------*/
/**
 * @brief   DCommsStateRemoteSerial class constructor
 * @param   commsMedium reference to comms medium
 * @retval  void
 */
DCommsStateRemoteSerial::DCommsStateRemoteSerial(DDeviceSerial *commsMedium)
 ...
 * @retval  next state
 */
eStateDuci_t DCommsStateRemoteSerial::run(void)
{
