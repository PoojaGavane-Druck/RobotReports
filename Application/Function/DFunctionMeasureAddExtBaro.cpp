...
/* User code --------------------------------------------------------------------------------------------------------*/
/**
 * @brief   DFunctionMeasureAddExtBaro class constructor
 * @param   void
 * @retval  void
 */
DFunctionMeasureAddExtBaro::DFunctionMeasureAddExtBaro(uint32_t index)
: DFunctionMeasure(index)
{
    myName = "fExt+Baro";
    myFunction = E_FUNCTION_ADD_EXT_BARO;
 ...
 * @retval  void
 */
void DFunctionMeasureAddExtBaro::createSlots(void)
{
 ...
 * @retval  void
 */
void DFunctionMeasureAddExtBaro::getSettingsData(void)
{
    //get address of data structure
    sPersistentFunctions_t *settings = DPI610E->persistentStorage->getFunctionSettingsAddr();

    //copy the data
    DPI610E->persistentStorage->getPersistentData((void *)&settings->data.measureSumExtBaro, (void *)&mySettings, sizeof(sFunctionSetting_t));
}
