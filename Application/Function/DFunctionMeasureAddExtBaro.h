...
#ifndef _DFUNCTION_MEASURE_ADD_EXT_BARO_H
#define _DFUNCTION_MEASURE_ADD_EXT_BARO_H
...
class DFunctionMeasureAddExtBaro : public DFunctionMeasure
{
protected:
...
public:
    DFunctionMeasureAddExtBaro(uint32_t index);
};
