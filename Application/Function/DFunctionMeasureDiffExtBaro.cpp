...
*
* @file     DFunctionMeasureDiffExtBaro.cpp
* @version  1.00.00
* @author   Harvinder Bhuhi
* @date     02 June 2020
*
* @brief    The DFunctionMeasureDiffExtBaro class source file
*/
//*********************************************************************************************************************
...
/* User code --------------------------------------------------------------------------------------------------------*/
/**
 * @brief   DFunctionMeasureDiffExtBaro class constructor
 * @param   void
 * @retval  void
 */
DFunctionMeasureDiffExtBaro::DFunctionMeasureDiffExtBaro(uint32_t index)
: DFunctionMeasure(index)
{
    myName = "fExt-Baro";
    myFunction = E_FUNCTION_DIFF_EXT_BARO;
 ...
 * @retval  void
 */
void DFunctionMeasureDiffExtBaro::createSlots(void)
{
 ...
 * @retval  void
 */
void DFunctionMeasureDiffExtBaro::getSettingsData(void)
{
    //get address of data structure
    sPersistentFunctions_t *settings = DPI610E->persistentStorage->getFunctionSettingsAddr();

    //copy the data
    DPI610E->persistentStorage->getPersistentData((void *)&settings->data.measureDiffExtBaro, (void *)&mySettings, sizeof(sFunctionSetting_t));
}
 ...
 * @retval  void
 */
void DFunctionMeasureDiffExtBaro::applySettings(void)
{
