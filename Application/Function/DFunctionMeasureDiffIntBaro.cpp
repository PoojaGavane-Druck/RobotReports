...
*
* @file     DFunctionMeasureDiffIntBaro.cpp
* @version  1.00.00
* @author   Harvinder Bhuhi
* @date     02 June 2020
*
* @brief    The DFunctionMeasureDiffIntBaro class source file
*/
//*********************************************************************************************************************
...
/* User code --------------------------------------------------------------------------------------------------------*/
/**
 * @brief   DFunctionMeasureDiffIntBaro class constructor
 * @param   void
 * @retval  void
 */
DFunctionMeasureDiffIntBaro::DFunctionMeasureDiffIntBaro(uint32_t index)
: DFunctionMeasure(index)
{
    myName = "fInt-Baro";
    myFunction = E_FUNCTION_DIFF_INT_BARO;
 ...
 * @retval  void
 */
void DFunctionMeasureDiffIntBaro::createSlots(void)
{
 ...
 * @retval  void
 */
void DFunctionMeasureDiffIntBaro::getSettingsData(void)
{
    //get address of data structure
    sPersistentFunctions_t *settings = DPI610E->persistentStorage->getFunctionSettingsAddr();

    //copy the data
    DPI610E->persistentStorage->getPersistentData((void *)&settings->data.measureDiffIntBaro, (void *)&mySettings, sizeof(sFunctionSetting_t));
}
 ...
 * @retval  void
 */
void DFunctionMeasureDiffIntBaro::applySettings(void)
{
