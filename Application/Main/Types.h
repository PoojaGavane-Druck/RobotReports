...
#define MAX_ALLOWED_DISTANCE_TRAVELLED 1000000.0f
...
typedef enum
{
    ...
    E_ERROR_BAROMETER_SENSOR_COM,
    E_ERROR_STEPPER_CONTROLLER,

    E_ERROR_MOTOR_VOLTAGE,
    E_ERROR_OVER_PRESSURE,
    E_ERROR_VALVE,
    E_ERROR_EEPROM,
    ...
    E_ERROR_OPTICAL_BOARD_NOT_FOUND,
    E_ERROR_CODE_RAM_FAILED,
    ...
    E_ERROR_DEVICE_DUE_FOR_SERVICE,

    E_ERROR_CODE_DRIVER_BLUETOOTH,
    E_ERROR_CODE_FIRMWARE_UPGRADE_FAILED,
    E_ERROR_CPU_AND_STACK_AND_CLOCK_TEST_FAILED,
    E_ERROR_BAROMETER_CAL_DEFAULT,

    E_ERROR_BAROMETER_CAL_REJECT,
    E_ERROR_RESERVED3,
    E_ERROR_RESERVED2,
    E_ERROR_RESERVED1
...
typedef enum
{
    ...
    E_RV_CMD_ITEM_BL_APPLICATION,
    E_RV_CMD_ITEM_BL_FIRMWARE,
    E_RV_CMD_ITEM_MAX
} eRvCmdItem;
...
typedef enum
{
    BL_STATE_DISCOVER = 0,
    BL_STATE_ENABLE = 1,
    BL_STATE_START_ADVERTISING = 2,
    BL_STATE_CONFIRM_PASSKEY = 3,
    BL_STATE_CONNECTED = 4,
    BL_STATE_PAIRED = 5,
    BL_STATE_DISABLE = 6,
    BL_STATE_DISCONNECT = 7,
    BL_STATE_RUN_ADV_IN_PROGRESS = 8,
    BL_STATE_RUN_CONNECTION_ESTABLISHED = 9,
    BL_STATE_RUN_ENCRYPTION_ESTABLISHED = 10,
    BL_STATE_ADV_TIMEOUT = 11,
    BL_STATE_NO_COMMUNICATION = 12,
    BL_STATE_NONE = 13,
    BL_STATE_MAX = 13
} eBL652State_t;
...
typedef enum
{
    eBL652_PAIR_MODE_ACCEPT = 0,
    eBL652_PAIR_MODE_REJECT = 1,
    eBL652_PAIR_MODE_MAX = 2,
    eBL652_PAIR_MODE_END = 0xFFFFFFFFu
} eBL652PairingMode_t;
