...
*
* @file     DProcessAlarmSensorLo.cpp
* @version  1.00.00
...
/* User code --------------------------------------------------------------------------------------------------------*/
/**
 * @brief   DProcessAlarmSensorLo class constructor
 * @param   void
 * @retval  void
 */
DProcessAlarmSensorLo::DProcessAlarmSensorLo(uint32_t channelIndex)
: DProcessAlarm(channelIndex)
{
    myProcessIndex = E_PROCESS_SENSOR_ALARM_LO;

    //by default sensor low alarm is enabled
    myEnabledState = true;
 ...
 */
float32_t DProcessAlarmSensorLo::run(float32_t input)
{
