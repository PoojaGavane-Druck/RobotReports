...
/**
 * @brief   Reads the time and date from RTC
 * @param   void
 * @retval  void
 */
...
/**
 * @brief   Sets the time and date of RTC
 * @param   void
 * @retval  void
 */
