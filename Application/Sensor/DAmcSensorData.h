...
public:
	...
	sAmcSensorCoefficientsData_t* GetSensorData() { return (sAmcSensorCoefficientsData_t*)&myCoefficientsData.amcSensorCoefficientsData; }
        uint8_t* getHandleToSensorDataMemory(){return myCoefficientsData.sensorCoefficientsDataMemory;}
        uint8_t* getHandleToSensorCalDataMemory(){return myCalibrationData.sensorCalibrationDataMemory;}
