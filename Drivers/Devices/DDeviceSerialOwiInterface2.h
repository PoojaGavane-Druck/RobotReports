...
#ifndef __DDEVICE_SERIAL_OWI_INTERFACE2_H
#define __DDEVICE_SERIAL_OWI_INTERFACE2_H
...
class DDeviceSerialOwiInterface2 : public DDeviceSerial
{
public:
    DDeviceSerialOwiInterface2();
