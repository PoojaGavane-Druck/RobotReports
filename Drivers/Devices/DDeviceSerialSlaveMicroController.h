...
#ifndef __DDEVICE_SERIAL_SLAVE_MICRO_H
#define __DDEVICE_SERIAL_SLAVE_MICRO_H
...
class DDeviceSerialSlaveMicroController : public DDeviceSerial
{
public:
    DDeviceSerialSlaveMicroController();
