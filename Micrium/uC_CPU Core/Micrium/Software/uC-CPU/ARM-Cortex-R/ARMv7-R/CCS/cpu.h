...
*                                                                         octet @ lowest memory address)
*
*           (3) (a) '__big_endian__'    is a CCS compiler #define that reflects the '--endian' option, 
*                   indicating the data word-memory order is defined as big    endian.
*
*               (b) '__little_endian__' is a CCS compiler #define that reflects the '--endian' option, 
*                   indicating the data word-memory order is defined as little endian.
*********************************************************************************************************
*/
...
#error  "CCS compiler '--endian' option NOT       #define'd"

#elif ((defined(__big_endian__   )) && \
       (defined(__little_endian__)))
#error  "CCS compiler '--endian' option illegally #define'd"
#endif
