...
*
*           (3) (a) '__TARGET_ARCH_ARM__'/'__TARGET_ARCH_THUMB__' are Keil MDK compiler #define's specifying 
*                    the number of the ARM/THUMB base architecture of the target CPU irrespective of whether 
*                    the compiler is compiling for ARM or Thumb mode :
*
*                             ARM VERSION        __TARGET_ARCH_ARM__   __TARGET_ARCH_THUMB__
*                                 v4                      4                     0
*                                 v4T                     4                     1
*                           v5T , v5TE , v5TEJ            5                     2
*                           v6  , v6K  , v6Z              6                     3
...
*                                   <compiler>                  directory name for specific compiler
*
*               (b) '__thumb__' is a Keil MDK compiler #define that reflects the selected CPU mode :
*
*                   (1) '__thumb__'     #define'd for Thumb
*                   (2) '__thumb__' not #define'd for ARM
*********************************************************************************************************
*/
...
#undef   CPU_CFG_LEAD_ZEROS_ASM_PRESENT                         /* ... assembly-version (see Note #1a).                 */
      ...
      ((defined(__TARGET_ARCH_ARM__)) && (__TARGET_ARCH_ARM__ >= 5)))
