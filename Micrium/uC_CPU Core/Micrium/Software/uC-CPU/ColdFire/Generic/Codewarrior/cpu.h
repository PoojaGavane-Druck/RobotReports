...
*                                         FUNCTION PROTOTYPES
*
* Note(s) : (1) The new version of CodeWarrior (7.2) requires to force the prototypes to the standard ABI
*               by using #pragma 'standard_abi'.
*********************************************************************************************************
*/

#if ((defined(__CWCC__)) && (__CWCC__ >= 0x72))
#pragma  standard_abi                                           /* See Note #1.                                         */
#endif

CPU_SR   CPU_SR_Save   (void);
void     CPU_SR_Restore(CPU_SR        cpu_sr);

void     CPU_VectInit  (CPU_INT32U    vbr);

void    *CPU_VectGet   (CPU_INT16U    vect);
void     CPU_VectSet   (CPU_INT16U    vect,
                        void        (*vect_addr)(void));
