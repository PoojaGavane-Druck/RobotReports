...
CPU_DATA  CPU_GetEID       (void);                              /* Get Exception ID register.                           */
CPU_DATA  CPU_GetGP        (void);                              /* Get Global Displacement pointer.                     */
CPU_DATA  CPU_GetTC        (void);                              /* Get Thread Control register.                         */
...
#define  CPU_INT_NBR                                   (8+__interrupts__)
#define  CPU_INT_INT0                                   8u
