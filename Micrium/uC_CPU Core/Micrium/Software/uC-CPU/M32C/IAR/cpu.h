...
*                           FnctName(p_obj);
*
*           (3) Some 64-bit data types are NOT (or might NOT) be supported by this CPU/compiler.  
*               However, in order to compile functionality/features requiring 64-bit support; 64-bit 
*               data types MUST be defined even if defined with a precision lower than 64-bits (e.g. 
