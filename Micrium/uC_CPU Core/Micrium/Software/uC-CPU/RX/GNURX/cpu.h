...
*
*           (4) Interrupt mask level is set to 'CPU_CFG_KA_IPL_BOUNDARY' to allow non-kernel aware ISRs 
...
#define  CPU_INT_GLOBAL_EN(void)                  __asm__ __volatile__ ("SETPSW I" : : : "memory");

#define  CPU_INT_VECT_TBL_BASE_SET(p_vect_tbl)    set_intb(p_vect_tbl)

#define  CPU_ISR                                  void  __attribute__ ((interrupt))
