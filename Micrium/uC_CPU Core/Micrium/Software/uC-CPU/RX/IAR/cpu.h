...
#define  CPU_IntDis()          do { __set_interrupt_level(CPU_CFG_KA_IPL_BOUNDARY); } while (0)
#else
#define  CPU_IntDis()          do { __set_interrupt_level(12); } while (0)
#endif
                                                                        /* Enable  interrupts.                          */
#define  CPU_IntEn()           do { __set_interrupt_level(0);  } while (0)
...
#ifdef   CPU_CFG_KA_IPL_BOUNDARY
#define  CPU_INT_DIS()         do { cpu_sr = __get_interrupt_level(); \
...
#define  CPU_INT_EN()          do { __set_interrupt_level(cpu_sr); } while (0)
#endif
...
#define  CPU_INT_GLOBAL_EN()                     asm(" SETPSW I")
#define  CPU_INT_VECT_TBL_BASE_SET(p_vect_tbl)   __set_interrupt_table(p_vect_tbl)
#define  CPU_ISR                                 __interrupt  void 
