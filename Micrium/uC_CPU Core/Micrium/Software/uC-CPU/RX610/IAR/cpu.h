...
#define  CPU_IntDis()          do { __set_interrupt_state(5); } while (0)   /* Disable interrupts.                      */
#define  CPU_IntEn()           do { __enable_interrupt();     } while (0)   /* Enable  interrupts.                      */
...
#define  CPU_INT_DIS()         do { cpu_sr = __get_interrupt_state(); \
                                    __set_interrupt_state(5);         } while (0)
