...
typedef enum{
	dSPIN_CONFIG_PWM_DIV_1		= (uint16_t)(((uint16_t)0x00)<<(uint16_t)13),
	dSPIN_CONFIG_PWM_DIV_2		= (uint16_t)(((uint16_t)0x01)<<13),
	dSPIN_CONFIG_PWM_DIV_3		= (uint16_t)(((uint16_t)0x02)<<13),
	dSPIN_CONFIG_PWM_DIV_4		= (uint16_t)(((uint16_t)0x03)<<13),
	dSPIN_CONFIG_PWM_DIV_5		= (uint16_t)(((uint16_t)0x04)<<13),
	dSPIN_CONFIG_PWM_DIV_6		= (uint16_t)(((uint16_t)0x05)<<13),
	dSPIN_CONFIG_PWM_DIV_7		= (uint16_t)(((uint16_t)0x06)<<13)
} dSPIN_CONFIG_F_PWM_INT_TypeDef;

typedef enum {
	dSPIN_CONFIG_PWM_MUL_0_625		= (uint16_t)(((uint16_t)0x00)<<10),
	dSPIN_CONFIG_PWM_MUL_0_75		= (uint16_t)(((uint16_t)0x01)<<10),
	dSPIN_CONFIG_PWM_MUL_0_875		= (uint16_t)(((uint16_t)0x02)<<10),
	dSPIN_CONFIG_PWM_MUL_1			= (uint16_t)(((uint16_t)0x03)<<10),
	dSPIN_CONFIG_PWM_MUL_1_25		= (uint16_t)(((uint16_t)0x04)<<10),
	dSPIN_CONFIG_PWM_MUL_1_5		= (uint16_t)(((uint16_t)0x05)<<10),
	dSPIN_CONFIG_PWM_MUL_1_75		= (uint16_t)(((uint16_t)0x06)<<10),
	dSPIN_CONFIG_PWM_MUL_2			= (uint16_t)(((uint16_t)0x07)<<10)
...
typedef enum {
	dSPIN_STATUS_MOT_STATUS_STOPPED			=(uint16_t)(((uint16_t)0x0000)<<5),
	dSPIN_STATUS_MOT_STATUS_ACCELERATION	=(uint16_t)(((uint16_t)0x0001)<<5),
	dSPIN_STATUS_MOT_STATUS_DECELERATION	=(uint16_t)(((uint16_t)0x0002)<<5),
	dSPIN_STATUS_MOT_STATUS_CONST_SPD		=(uint16_t)(((uint16_t)0x0003)<<5)
...
#define KTherm_to_Par(KTherm) ((uint8_t)(((KTherm - (uint8_t)1)/0.03125)+0.5))			/* K_THERM compensation conversion, range 1 to 1.46875 */
