...
/* Variables ----------------------------------------------------------------*/
char smbusSemTxName[MAX_SEM_NAME_SIZE] = "SmbusTx";
char smbusSemRxName[MAX_SEM_NAME_SIZE] = "SmbusRx";
